...
import { LayoutDashboard, Users, CreditCard, Package, BarChart3, Settings, LogOut, Building2, Wallet, Brain, Zap, TrendingUp, Users2, Gamepad2, MapPin, Store, Calendar, Smartphone, UserCheck } from "lucide-react";
...
var allSidebarItems = [
    ...
    { icon: Zap, label: "Operations Dashboard", href: "/dashboards/operations", roles: ["admin"] },
    { icon: TrendingUp, label: "Risk Management Dashboard", href: "/dashboards/risk", roles: ["admin"] },
