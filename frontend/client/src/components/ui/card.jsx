...
var Card = React.forwardRef(function (_a, ref) {
    ...
    return (<div ref={ref} className={cn(variant === "default"
            ? "rounded-xl border bg-card text-card-foreground shadow glass-card gradient-border hover-tilt relative overflow-visible"
...
var CardContent = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<div ref={ref} className={cn("p-6 pt-0 relative z-20", className)} {...props}/>);
});
